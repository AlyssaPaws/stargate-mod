        ...
        public void OpenStargate(PlanetTile address)
         {
             ...
             if (!connectedMap.HasMap)
             {
                 ...
                 }, "GeneratingStargateSite", doAsynchronously: false, GameAndMapInitExceptionHandlers.ErrorWhileGeneratingMap, callback: delegate
                 {
...
private void DoUnstableVortex()
        ...
        public override void PostSpawnSetup(bool respawningAfterLoad)
        {
            ...
            if (Prefs.LogVerbose)
            {
                Log.Message($"StargateMod: compsg postspawnssetup: sgactive={StargateIsActive} connectgate={_connectedStargate} connectaddress={_connectedAddress}, mapparent={parent.Map.Parent}, connectedPMAddress={_connectedAddressPocketMap}");   
            }
        }
        ...
        public string GetInspectString()
        {
            ...
            if (StargateIsActive)
                sb.AppendLine("ConnectedToGate".Translate(connectedDisplayAddress,
